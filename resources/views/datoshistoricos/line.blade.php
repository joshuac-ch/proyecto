<h1>Estado de Oportunidad por los mejores sectores exitosos</h1>
...
<script>
    ...
    var ctx2 = document.getElementById('ventas333PorCanalEstadoChart').getContext('2d');
    var ventas333PorCanalEstadoChart = new Chart(ctx2, {
        type: 'bar',
        data: {
            labels: regiones,
