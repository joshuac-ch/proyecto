...
<h1>Sectores del Cliente Compilados </h1>

<canvas id="ventasPorSectorEstadoChart1" width="900" height="300"></canvas>

<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
<script>
    // Datos en JSON desde el backend
    var ventasHistoricas = @json($historias);
    ...
    var ctx = document.getElementById('ventasPorSectorEstadoChart1').getContext('2d');
